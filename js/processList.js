...
function getData(){
	...
	data: 'tablename=process&pagenumber='+nowPage, //发给php
	...
	success: function(json){
		 ...
		 $.each(results,function() {
		 	var tag="标签：";
		 	if(this.poster){
		 		var links="<a href=\"rulesPage.php?rulesid="+this.id+ "\"><img src=\""+this.poster+"\" alt=\""+this.title+"\">"+"<h1>"+this.title+"</h1></a>";
		 	}
		 	else{
		 		var links="<a href=\"rulesPage.php?rulesid="+this.id+ "\"><h1>"+this.title+"</h1></a>";
		 	}
		 	if(this.tag){
